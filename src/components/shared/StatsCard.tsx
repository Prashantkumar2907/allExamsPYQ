...
export function StatsCard({ title, value, icon: Icon, trend, className }: StatsCardProps) {
  return (
    <Card className={cn('relative flex items-center gap-4 p-4 md:p-5 overflow-hidden hover:border-[var(--border-strong)] hover:shadow-[0_2px_8px_var(--shadow)] transition-all duration-200 group', className)}>
      ...
      <div className="h-11 w-11 rounded-xl bg-[var(--primary)]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[var(--primary)]/15 group-hover:scale-105 transition-all duration-200">
